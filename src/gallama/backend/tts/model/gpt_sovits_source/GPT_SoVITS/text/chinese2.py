...
if is_g2pw:
    ...
    model_dir_path = os.path.expanduser("~/gallama/models/gpt-sovits/text/G2PWModel")
    model_source_path = os.path.expanduser("~/gallama/models/gpt-sovits/chinese-roberta-wwm-ext-large")
